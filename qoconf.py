...
autoqps_path = "/search/odin/daemon/automission/webqo"  # 工具路径地址

online_host = "rsync.webqo01.web.1.djt.ted"         # 线上host
online_path = "/search/odin/daemon/qo"              # 线上路径
...
local_ip='10.144.82.27'                     # 本地ip
root_path="/search/odin/daemon/webqo/"      # 本地地址

test_path_1="qo_test"                       # 本地测试路径
base_path_1="qo_base"                       # 线上测试路径

ol_data_path_1="/search/summary_o/webqo"    # 线上数据文件
