...
def diff_query(base, test, mission_id):
    ...
    if base == "http://webqw01.web.djt.ted:8019/request":
        ...
        with open("longdiff_query2", 'r+') as file:
            for line in file.readlines():
                ...
                print(base_resp.text)
                print("aa:",BeautifulSoup(base_resp.text))



                if base_resp.text==test_resp.text:

                    data_base = BeautifulSoup(base_resp.text,"html5lib")
                    print('ll:',repr(data_base).decode('unicode-escape'))
        ...
        with open("longdiff_query2", 'r+') as file:
            for line in file.readlines():
                ...
                if base_resp.text!=test_resp.text:
                    base_result_qo += base_resp.text.encode('utf-')
...
if __name__ == '__main__':
    diff_query("http://webqw01.web.djt.ted:8019/request", "http://webqw01.web.djt.ted:8019/request",7)
